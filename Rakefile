...
task :darchive do
    sh "cap deploy -S target=darchive.fcla.edu:/opt/web-services/sites/actionplan -S who=daitss:daitss"
end
...
task :ripple do
    sh "cap deploy -S target=ripple.fcla.edu:/opt/web-services/sites/actionplan -S who=daitss:daitss"
end

desc "deploy to tarchive's coop (actionplan.tarchive.fcla.edu?)"
task :tarchive_coop do
    sh "cap deploy -S target=tarchive.fcla.edu:/opt/web-services/sites/coop/actionplan -S who=daitss:daitss"
end
